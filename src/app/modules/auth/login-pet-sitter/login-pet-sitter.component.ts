...
@Component({
  selector: "app-login-pet-sitter",
  templateUrl: "./login-pet-sitter.component.html",
  styleUrls: ["./login-pet-sitter.component.scss"],
  providers: [AuthService],
})
export class LoginPetSitterComponent implements OnInit {
    ...
    if (this.formLogin.valid) {
      ...
      this.authService.loginWithParams(login_data).subscribe(
        (data) => {
          ...
          this.router.navigate(["/dashboard/petsitter"]);
        },
        (error) => {
